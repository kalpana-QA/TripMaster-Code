...
//	@Test(groups= {"smoke"},priority=4)
	...
	@Test(groups= {"smoke"},priority=4)
	public void flightBookingWithFirstPackage_WithChanges_TC_4(Method method) throws Exception {
		 ExtentTest test = ExtentTestManager.startTest(method.getName(), "flightBookingWithFirstPackage");
...
<<<<<<< Updated upstream
	...
	public void bookingTwoRoomTwoAdultTwoChild_WithChanges_TC_5(Method method) throws Exception {
		...
		bookingPage.clickonExploreEuropeLnk();
		test.log(LogStatus.INFO, "User clicked on Explore Europe Link");
		bookingPage.clickOnPackageDisplayedUnderSuggestedVacationPackageOption();
		test.log(LogStatus.INFO, "User clicked on particular vacation package");
		bookingPage.clickOnReorderCitiesLink();
...
>>>>>>> Stashed changes
	...
	@Test(groups= {"smoke"},priority=6)
	public void bookingFlightsWithmultipleCities_withChanges_TC_6(Method method) throws Exception {
		ExtentTest test = ExtentTestManager.startTest(method.getName(), "bookingFlightsWithmultipleCities");
  ...
  //  @Test(groups= {"smoke"},priority=7)
	...
	public void bookingFlightAndHotelForSingleCity_TC_7(Method method) throws Exception {
		...
		bookingPage.clicktoContinuePage();
		PageBase.waitForElement(3);
		String expectedflight = bookingPage.selectCheaperFlights();
		...
		System.out.println("Actual is:" +actualFlightDetails   + " "+ "Expected is :"+expectedflight);
		PageBase.waitForElement(3);
		System.out.println("Second assertion started");
		Assert.assertTrue(expectedflight.contains(actualFlightDetails));
	...
	@Test(groups= {"smoke"},priority=7)
		public void bookingFlightAndHotelForSingleCity_WithChanges_TC_7(Method method) throws Exception {
			ExtentTest test=ExtentTestManager.startTest(method.getName(), "bookingFlightAndHotelForSingleCity");
			homePage.topdeals();
...
//	@Test(groups= {"smoke"},priority=8)
	...
	@Test(groups= {"smoke"},priority=8)
	  public void europePageBookingForMultipleCities_TC_8(Method method) throws Exception {
		ExtentTest test=ExtentTestManager.startTest(method.getName(), "europePageBookingForMultipleCities");
		homePage.clickOnExploreEuropeLink();
		...
		// bookingPage.clickonContinue();
	     ...
	     test.log(LogStatus.INFO, "Select particular hotel from Hotel Options");
			...
			String expectedSecondcityHotel = bookingPage.browseHotelSecondCity();
			...
			String actualsecondCityHotel = bookingPage.secondCityHotelName();
			//PageBase.waitForElement(10);
  ...
  @Test(groups= {"regression"},priority=14)
		public void dateChanging_TC_9(Method method) throws Exception {
			...
			test.log(LogStatus.INFO, "User is able to change date successfully ");
	...
	public void removeAddedCity_WithAdditonalChanges_TC_17(Method method) throws Exception {
		...
		homePage.clickOnExploreAsiaLink();
		test.log(LogStatus.INFO, "User click on Explore Asia Link");
		bookingPage.clickOnBuildYourVacationDropDown();
		PageBase.waitForElement(3);
		bookingPage.fillLeavingFromDetails("New York, Newark, NJ");
		test.log(LogStatus.INFO, "User entered \"New York, Newark, NJ\" into leaving from field");
...
>>>>>>> Stashed changes
		...
		test.log(LogStatus.INFO, "All the added cities removed from itenary successfully.Verified!");
		logs.info("All the added cities removed  from itenary successfully.Verified!");
		bookingPage.clickOnAddCityBtn();
		...
		bookingPage.selectStayingTimeTwo("1");
		test.log(LogStatus.INFO, "User entered \"1\" nights staying time");
		PageBase.waitForElement(3);
		bookingPage.selectNoMoreCitiesBtn();
       ...
       // bookingPage.selectNumberOfAdult("1", BookingLocators.getselectAdultRoom2Drpdown());
		bookingPage.selectnumberofadultsRoom_2iOS();
		test.log(LogStatus.INFO, "Booking details filled successfully for Two Adults & one Child");
		bookingPage.doneButtonMob();
	    bookingPage.clickonContinueButton();
		bookingPage.selectCheaperFlights();
		test.log(LogStatus.INFO, "Select Cheaper flights from flight options");
