...
//		//Logs.info("Booking details filled successfully for multiple cities");
	...
	@Test(groups= {"smoke"},priority=7)
	public void TC_0007_bookingFlightAndTwoRoomsWithAdultsAndChilds_FromTopDalPackages(Method method) throws Exception {
		ExtentTest test=ExtentTestManager.startTest(method.getName(), "TC_0007_bookingFlightAndTwoRoomsWithAdultsAndChilds_FromTopDalPackages");
		test.log(LogStatus.INFO, "Entered the URL: http://www.tripmasters.com/");
