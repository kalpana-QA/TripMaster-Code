...
public class PageBase {
	...
	public String ClearAndSetValues(By FieldElement, String StringToBeEntered) throws Exception {
	 ...
	 * @version 1
	 **/
	public void ClickUsingJavaScript(By FieldElement) {
	...
	public String SelectOptionByValue(By element, String valueOfOption) {
	...
	public String SelectOptionByText(By element, String optionText) {
	...
	public void VerifyTravellerDetails(By element, List<String> expectedTravellerInfo) {
		try {
	...
	public String selectNewDateFromCalendar() {
	...
	public void waitForElement(int time) throws Exception {
